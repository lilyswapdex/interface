import { ChainId, JSBI, Percent, Token, WAVAX } from '@lilyswapdex/sdk'
...
export const LANDING_PAGE = 'https://lilyswap.app/'
export const ANALYTICS_PAGE = 'https://info.lilyswap.app/'
...
export const PNG: { [chainId in ChainId]: Token } = {
  [ChainId.FUJI]: new Token(ChainId.FUJI, '0x83080D4b5fC60e22dFFA8d14AD3BB41Dde48F199', 18, 'LILY', 'Lilyswap'),
  [ChainId.AVALANCHE]: new Token(ChainId.AVALANCHE, '0x60781C2586D68229fde47564546784ab3fACA982', 18, 'LILY', 'Lilyswap')
}
...
export const WYRE_CALLBACK_URL = 'https://trade.lilyswap.app/'
