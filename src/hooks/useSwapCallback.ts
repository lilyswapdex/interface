...
import { JSBI, Percent, Router, SwapParameters, Trade, TradeType } from '@lilyswapdex/sdk'
                ...
                return contract.callStatic[methodName](...args, options)
                  ...
                  .catch(callError => {
                    ...
                    switch (callError.reason) {
                      case 'LilyswapRouter: INSUFFICIENT_OUTPUT_AMOUNT':
                      case 'LilyswapRouter: EXCESSIVE_INPUT_AMOUNT':
                        errorMessage =
